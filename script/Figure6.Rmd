---
title: "Fig. 6 Comparison of low-input protein identifications between SpectronautTM version 15 and 16"
...
Data tables were exported from Spectronaut (version 15.5.211111.50606 or 16.0.220606.53000) in csv files and need to be loaded in RStudio with the function `read.csv2()`.
...
LITDIA_Turbo_5_SN15 <- read.csv2(paste0(lit_path, "20220502_LIT_Turbo_DIA_5ng_40SPD_whisper100_1CV_auto.csv"))
...
LITDIA_Rapid_5_SN15 <- read.csv2(paste0(lit_path, "20220502_LIT_Rapid_DIA_5ng_40SPD_whisper100_1CV_auto.csv"))
...
LITDIA_Normal_5_SN15 <- read.csv2(paste0(lit_path, "20220502_LIT_Normal_DIA_5ng_40SPD_whisper100_1CV_auto.csv"))
...
LITDIA_Turbo_5_SN16 <- read.csv2(paste0(lit_path, "20220615_SN16_40SPD_LIT_Turbo_1CV_5ng_auto_40w.csv"))
...
LITDIA_Rapid_5_SN16 <- read.csv2(paste0(lit_path, "20220615_SN16_40SPD_LIT_Rapid_1CV_5ng_auto_40w.csv"))
...
LITDIA_Normal_5_SN16 <- read.csv2(paste0(lit_path, "20220615_SN16_40SPD_LIT_Normal_1CV_5ng_auto_40w.csv"))
...
LITDIA_Turbo_5_SN15 <-  filter_pep(LITDIA_Turbo_5_SN15)
...
LITDIA_Rapid_5_SN15 <-  filter_pep(LITDIA_Rapid_5_SN15)
...
LITDIA_Normal_5_SN15 <-  filter_pep(LITDIA_Normal_5_SN15)
...
LITDIA_Turbo_5_SN16 <-  filter_pep(LITDIA_Turbo_5_SN16)
...
LITDIA_Rapid_5_SN16 <-  filter_pep(LITDIA_Rapid_5_SN16)
...
LITDIA_Normal_5_SN16 <-  filter_pep(LITDIA_Normal_5_SN16)
...
```{r}
id_LITDIA_Turbo_1_SN15 <- id_LITDIA_Turbo_5_SN15 <- id_LITDIA_Turbo_10_SN15 <- id_LITDIA_Turbo_100_SN15 <-
id_LITDIA_Rapid_1_SN15 <- id_LITDIA_Rapid_5_SN15 <- id_LITDIA_Rapid_10_SN15 <- id_LITDIA_Rapid_100_SN15 <-
id_LITDIA_Normal_1_SN15 <- id_LITDIA_Normal_5_SN15 <- id_LITDIA_Normal_10_SN15 <- id_LITDIA_Normal_100_SN15 <-

id_LITDIA_Turbo_1_SN16 <- id_LITDIA_Turbo_5_SN16 <- id_LITDIA_Turbo_10_SN16 <- id_LITDIA_Turbo_100_SN16 <-
id_LITDIA_Rapid_1_SN16 <- id_LITDIA_Rapid_5_SN16 <- id_LITDIA_Rapid_10_SN16 <- id_LITDIA_Rapid_100_SN16 <-
id_LITDIA_Normal_1_SN16 <- id_LITDIA_Normal_5_SN16 <- id_LITDIA_Normal_10_SN16 <- id_LITDIA_Normal_100_SN16 <- rep(NA, 4)
```
...
for(i in 2:5){
  id_LITDIA_Turbo_5_SN15[i-1] <- sum(!is.na(LITDIA_Turbo_5_SN15[, i]))}
...
for(i in 2:5){
  id_LITDIA_Rapid_5_SN15[i-1] <- sum(!is.na(LITDIA_Rapid_5_SN15[, i]))}
...
for(i in 2:5){
  id_LITDIA_Normal_5_SN15[i-1] <- sum(!is.na(LITDIA_Normal_5_SN15[, i]))}
...
for(i in 2:5){
  id_LITDIA_Turbo_5_SN16[i-1] <- sum(!is.na(LITDIA_Turbo_5_SN16[, i]))}
...
for(i in 2:5){
  id_LITDIA_Rapid_5_SN16[i-1] <- sum(!is.na(LITDIA_Rapid_5_SN16[, i]))}
...
for(i in 2:5){
  id_LITDIA_Normal_5_SN16[i-1] <- sum(!is.na(LITDIA_Normal_5_SN16[, i]))}
...
LITDIA_Turbo_5_SN15_cv <- compute_CV(LITDIA_Turbo_5_SN15)
LITDIA_Turbo_5_SN15_cv$input<- "5 ng"
LITDIA_Turbo_5_SN15_cv$version<- "S15"
LITDIA_Turbo_5_SN15_cv$scanning_mode<- "Turbo"
...
LITDIA_Rapid_5_SN15_cv <- compute_CV(LITDIA_Rapid_5_SN15)
LITDIA_Rapid_5_SN15_cv$input<- "5 ng"
LITDIA_Rapid_5_SN15_cv$version<- "S15"
LITDIA_Rapid_5_SN15_cv$scanning_mode<- "Rapid"
...
LITDIA_Normal_5_SN15_cv <- compute_CV(LITDIA_Normal_5_SN15)
LITDIA_Normal_5_SN15_cv$input<- "5 ng"
LITDIA_Normal_5_SN15_cv$version<- "S15"
LITDIA_Normal_5_SN15_cv$scanning_mode<- "Normal"
...
LITDIA_Turbo_5_SN16_cv <- compute_CV(LITDIA_Turbo_1_SN16)
LITDIA_Turbo_5_SN16_cv$input<- "5 ng"
LITDIA_Turbo_5_SN16_cv$version<- "S16"
LITDIA_Turbo_5_SN16_cv$scanning_mode<- "Turbo"
...
LITDIA_Rapid_5_SN16_cv$input<- "5 ng"
LITDIA_Rapid_5_SN16_cv$version<- "S16"
LITDIA_Rapid_5_SN16_cv$scanning_mode<- "Rapid"
...
LITDIA_Normal_5_SN16_cv <- compute_CV(LITDIA_Normal_1_SN16)
LITDIA_Normal_5_SN16_cv$input<- "5 ng"
LITDIA_Normal_5_SN16_cv$version<- "S16"
LITDIA_Normal_5_SN16_cv$scanning_mode<- "Normal"
...
```{r}
id_figure6 <- 
  rbind(LITDIA_Turbo_1_SN15_cv, LITDIA_Turbo_5_SN15_cv, LITDIA_Turbo_10_SN15_cv, LITDIA_Turbo_100_SN15_cv,
LITDIA_Rapid_1_SN15_cv, LITDIA_Rapid_5_SN15_cv, LITDIA_Rapid_10_SN15_cv, LITDIA_Rapid_100_SN15_cv,
LITDIA_Normal_1_SN15_cv, LITDIA_Normal_5_SN15_cv, LITDIA_Normal_10_SN15_cv, LITDIA_Normal_100_SN15_cv,

LITDIA_Turbo_1_SN16_cv, LITDIA_Turbo_5_SN16_cv, LITDIA_Turbo_10_SN16_cv, LITDIA_Turbo_100_SN16_cv,
LITDIA_Rapid_1_SN16_cv, LITDIA_Rapid_5_SN16_cv, LITDIA_Rapid_10_SN16_cv, LITDIA_Rapid_100_SN16_cv,
LITDIA_Normal_1_SN16_cv, LITDIA_Normal_5_SN16_cv, LITDIA_Normal_10_SN16_cv, LITDIA_Normal_100_SN16_cv)
...
figure6 <- id_figure6 %>% filter(input != "5 ng") %>%
