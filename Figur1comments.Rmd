...
Information about the method and the input are added afterwards.
...
The data frames are combined with the function `rbind()`. Only the columns, which are necessary to figure out, if LIT abundance was found are kept.
