...
LIT Turbo DIA
```{r}
LITDIA_Turbo_5$FG.Quantity[as.logical(LITDIA_Turbo_5$EG.IsImputed)] <- NA
  
LITDIA_Turbo_5 <- LITDIA_Turbo_5 %>% 
  group_by(R.FileName, PEP.StrippedSequence) %>% 
  summarise(mean_quantity = mean(FG.Quantity, na.rm = TRUE)) %>%  
  pivot_wider(names_from = R.FileName, 
              values_from = mean_quantity) 
...
LITDIA_Turbo_5_filter <- LITDIA_Turbo_5 %>% 
  mutate(na_nbr = rowSums(is.na(LITDIA_Turbo_5[-1]))) %>% 
  mutate(LITDIA_mean_quantity = rowMeans(LITDIA_Turbo_5[2:5], na.rm = TRUE)) %>% 
  filter(na_nbr <= 1) 

dim(LITDIA_Turbo_5_filter)
```
...
LIT Turbo DIA
```{r}
LITDIA_Turbo_10$FG.Quantity[as.logical(LITDIA_Turbo_10$EG.IsImputed)] <- NA
  
LITDIA_Turbo_10 <- LITDIA_Turbo_10 %>% 
  group_by(R.FileName, PEP.StrippedSequence) %>% 
  summarise(mean_quantity = mean(FG.Quantity, na.rm = TRUE)) %>%  
  pivot_wider(names_from = R.FileName, 
              values_from = mean_quantity) 
...
LITDIA_Turbo_10_filter <- LITDIA_Turbo_10 %>% 
  mutate(na_nbr = rowSums(is.na(LITDIA_Turbo_10[-1]))) %>% 
  mutate(LITDIA_mean_quantity = rowMeans(LITDIA_Turbo_10[2:5], na.rm = TRUE)) %>% 
  filter(na_nbr <= 1) 

dim(LITDIA_Turbo_10_filter)
```
...
LITDIA Turbo vs OT 7.5k
```{r}
joined <- inner_join(OTDIA_7k_1_filter[,c(1, 7)], LITDIA_Turbo_1_filter[, c(1, 7)])
Turbo_vs_7k_1ng <- joined %>% 
  ...
  scale_x_log10()+
  scale_y_log10()+
  labs(x = "OT 7k Abundance (log10)",
       y = "LIT Turbo Abundance (log10)",
       title = "1 ng Input")+
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5))+ 
  annotate("text", 
           x = min(joined$OT_mean_quantity), 
           y = max(joined$LITDIA_mean_quantity),
           hjust = 0,
           vjust = 3.5,
           label = paste0(nrow(inner_join(OTDIA_7k_1_filter[,c(1, 7)], LITDIA_Turbo_1_filter[, c(1, 7)])), " peptides" ))


Turbo_vs_7k_1ng
```

LITDIA Rapid vs OT 15k
```{r}
joined <- inner_join(OTDIA_15k_1_filter[,c(1, 7)],
                     LITDIA_Rapid_1_filter[, c(1, 7)])
Rapid_vs_15k_1ng <- joined %>%
  ggplot(aes(x = OT_mean_quantity, y = LITDIA_mean_quantity)) +
  geom_pointdensity(size = 2)+
  geom_smooth(method = lm,
              se = FALSE,
  ...
  scale_x_log10()+
  scale_y_log10()+
  labs(x = "OT 15k Abundance (log10)",
       y = "LIT Rapid Abundance (log10)",
       title = "1 ng Input")+
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5))+ 
  annotate("text", 
           ...
           hjust = 0,
           vjust = 3.5,
           label = paste0(nrow(inner_join(OTDIA_15k_1_filter[,c(1, 7)], LITDIA_Rapid_1_filter[, c(1, 7)])), " peptides" ))

Rapid_vs_15k_1ng
```

LITDIA Normal vs OT 30k
```{r}
joined <- inner_join(OTDIA_30k_1_filter[,c(1, 7)],
                     LITDIA_Normal_1_filter[, c(1, 7)])
Normal_vs_30k_1ng <- joined %>%
  ggplot(aes(x = OT_mean_quantity, y = LITDIA_mean_quantity)) +
  geom_pointdensity(size = 2)+
  geom_smooth(method = lm,
              se = FALSE,
  ...
  scale_x_log10()+
  scale_y_log10()+
  labs(x = "OT 30k Abundance (log10)",
       y = "LIT Normal Abundance (log10)",
       title = "1 ng Input")+
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5))+ 
  annotate("text",  
           ...
           hjust = 0,
           vjust = 3.5,
           label = paste0(nrow(inner_join(OTDIA_30k_1_filter[,c(1, 7)], LITDIA_Normal_1_filter[, c(1, 7)])), " peptides" ))
...
LITDIA Turbo vs OT 7.5k
```{r}
joined <- inner_join(OTDIA_7k_100_filter[,c(1, 7)],
                     LITDIA_Turbo_100_filter[, c(1, 7)])
Turbo_vs_7k_100ng <- joined %>%
  ggplot(aes(x = OT_mean_quantity, y = LITDIA_mean_quantity)) +
  geom_pointdensity(size = 2)+
  geom_smooth(method = lm,
              se = FALSE,
  ...
  annotate("text",  
           ...
           hjust = 0,
           vjust = 3.5,
           label = paste0(nrow(inner_join(OTDIA_7k_100_filter[,c(1, 7)], LITDIA_Turbo_100_filter[, c(1, 7)])), " peptides" ))
...
LITDIA Rapid vs OT 15k
```{r}
joined <- inner_join(OTDIA_15k_100_filter[,c(1, 7)],
                     LITDIA_Rapid_100_filter[, c(1, 7)])
Rapid_vs_15k_100ng <- joined %>%
  ggplot(aes(x = OT_mean_quantity, y = LITDIA_mean_quantity)) +
  geom_pointdensity(size = 2)+
  geom_smooth(method = lm,
              se = FALSE,
  ...
  annotate("text",  
           ...
           hjust = 0,
           vjust = 3.5,
           label = paste0(nrow(inner_join(OTDIA_15k_100_filter[,c(1, 7)], LITDIA_Rapid_100_filter[, c(1, 7)])), " peptides" ))
...
```{r}
Normal_vs_30k_100ng <- 
  inner_join(OTDIA_30k_100_filter[,c(1, 7)], LITDIA_Normal_100_filter[, c(1, 7)]) %>%
  ggplot(aes(x = OT_mean_quantity, y = LITDIA_mean_quantity)) +
  geom_pointdensity(size = 2)+
  geom_smooth(method = lm,
              se = FALSE,
  ...
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5))+ 
  annotate("text", x = 530, y = 15000, label = paste0(nrow(inner_join(OTDIA_30k_100_filter[,c(1, 7)], LITDIA_Normal_100_filter[, c(1, 7)])), " peptides" ))
...
```{r}
Turbo_vs_7k_1_facet <- inner_join(OTDIA_7k_1_filter[,c(1,7)],
                                LITDIA_Turbo_1_filter[,c(1,7)])
Turbo_vs_7k_1_facet$method <- "LIT Turbo vs OT 7k"
Turbo_vs_7k_1_facet$input <- "1 ng"

Rapid_vs_15k_1_facet <- inner_join(OTDIA_15k_1_filter[,c(1,7)],
                                LITDIA_Rapid_1_filter[,c(1,7)])
Rapid_vs_15k_1_facet$method <- "LIT Rapid vs OT 15k"
Rapid_vs_15k_1_facet$input <- "1 ng"

Normal_vs_30k_1_facet <- inner_join(OTDIA_30k_1_filter[,c(1,7)],
                                LITDIA_Normal_1_filter[,c(1,7)])
...
### 100 ng  
```{r}
Turbo_vs_7k_100_facet <- inner_join(OTDIA_7k_100_filter[,c(1,7)],
                                LITDIA_Turbo_100_filter[,c(1,7)])
Turbo_vs_7k_100_facet$method <- "LIT Turbo vs OT 7k"
Turbo_vs_7k_100_facet$input <- "100 ng"

Rapid_vs_15k_100_facet <- inner_join(OTDIA_15k_100_filter[,c(1,7)],
                                LITDIA_Rapid_100_filter[,c(1,7)])
Rapid_vs_15k_100_facet$method <- "LIT Rapid vs OT 15k"
Rapid_vs_15k_100_facet$input <- "100 ng"

Normal_vs_30k_100_facet <- inner_join(OTDIA_30k_100_filter[,c(1,7)],
                                LITDIA_Normal_100_filter[,c(1,7)])
...
OT_in_LIT <- 
  rbind(LITDIA_Turbo_1_filter[,-c(2:6)], LITDIA_Turbo_100_filter[,-c(2:6)],
        LITDIA_Rapid_1_filter[,-c(2:6)], LITDIA_Rapid_100_filter[,-c(2:6)],
        LITDIA_Normal_1_filter[,-c(2:6)], LITDIA_Normal_100_filter[,-c(2:6)]) 
...
```{r}
colnames(LITDIA_Turbo_1_filter)
colnames(LITDIA_Turbo_100_filter)
```
...
labels1 <- c(paste0(sum(OT_in_LIT$method == "Turbo" & 
                          OT_in_LIT$input == "1 ng" &
                          OT_in_LIT$in_OT == FALSE),
                  " peptides"),
             paste0(sum(OT_in_LIT$method == "Rapid" & 
                          OT_in_LIT$input == "1 ng" &
                          OT_in_LIT$in_OT == FALSE),
                    " peptides"),
             paste0(sum(OT_in_LIT$method == "Normal" & 
                          OT_in_LIT$input == "1 ng" &
                          OT_in_LIT$in_OT == FALSE),
                    " peptides"),
             paste0(sum(OT_in_LIT$method == "Turbo" & 
                          OT_in_LIT$input == "100 ng" &
                          OT_in_LIT$in_OT == FALSE),
                  " peptides"),
             paste0(sum(OT_in_LIT$method == "Rapid" & 
                          OT_in_LIT$input == "100 ng" &
...
labels2 <- c(paste0(sum(OT_in_LIT$method == "Turbo" & 
                          OT_in_LIT$input == "1 ng" &
                          OT_in_LIT$in_OT == TRUE),
                  " peptides"),
             paste0(sum(OT_in_LIT$method == "Rapid" & 
                          OT_in_LIT$input == "1 ng" &
                          OT_in_LIT$in_OT == TRUE),
...
```{r}
LIT_in_OT <- 
  rbind(OTDIA_7k_1_filter[,-c(2:6)], OTDIA_7k_100_filter[,-c(2:6)],
        OTDIA_15k_1_filter[,-c(2:6)], OTDIA_15k_100_filter[,-c(2:6)],
        OTDIA_30k_1_filter[,-c(2:6)], OTDIA_30k_100_filter[,-c(2:6)]) 
...
LIT_in_OT_plot <- LIT_in_OT %>% 
  ggplot(aes(x = OT_mean_quantity, fill = in_LIT))+
  geom_histogram(position = position_dodge(),
                 bins = 20)+
  scale_x_log10()+
  scale_fill_manual(values = c("grey65", "red"),
...
# CV (again but harder, better, faster (maybe not), stronger)
...
LITDIA_Turbo
```{r}
LITDIA_Turbo_1_CV <- LITDIA_Turbo_1 %>% 
  ...
  mutate(CV = mean_quantity/sd_quantity,
         method = "LITDIA_Turbo",
         input = "1 ng")
```
...
LITDIA_Rapid
```{r}
LITDIA_Rapid_1_CV <- LITDIA_Rapid_1 %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
LITDIA_Normal
```{r}
LITDIA_Normal_1_CV <- LITDIA_Normal_1 %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
LITDIA_Turbo
```{r}
LITDIA_Turbo_100_CV <- LITDIA_Turbo_100 %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
LITDIA_Rapid
```{r}
LITDIA_Rapid_100_CV <- LITDIA_Rapid_100 %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
LITDIA_Normal
```{r}
LITDIA_Normal_100_CV <- LITDIA_Normal_100 %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
OTDIA_15k 
```{r}
OTDIA_15k_100_CV <- OTDIA_15k_100 %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
OTDIA_30k 
```{r}
OTDIA_30k_100_CV <- OTDIA_30k_100 %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
CV_joined %>% group_by(method, input) %>% 
  summarise(med = median(CV, na.rm = TRUE))
median(LITDIA_Turbo_1_CV$CV, na.rm = TRUE)
```
???
this plot %in% my understanding
[1] FALSE
