...
pp_path <- 
  "C://Users/samgr/OneDrive - UCL/Documents/Internship/Data/LITDIA/points per peak/"
```
...
LIT Turbo DIA
```{r}
LITDIA_Turbo_1 <- read.csv2(paste0(lit_path, "20220420_LIT_Turbo_DIA_1ng_40SPD_whisper100_1CV_8ms.csv"))
LITDIA_Turbo_5 <- read.csv2(paste0(lit_path, "20220420_LIT_Turbo_DIA_5ng_40SPD_whisper100_1CV_8ms.csv"))
LITDIA_Turbo_10 <- read.csv2(paste0(lit_path, "20220420_LIT_Turbo_DIA_10ng_40SPD_whisper100_1CV_8ms.csv"))
LITDIA_Turbo_100 <- read.csv2(paste0(lit_path, "20220420_LIT_Turbo_DIA_100ng_40SPD_whisper100_1CV_8ms.csv"))

LITDIA_Turbo_1_auto <- read.csv2(paste0(lit_path, "20220502_LIT_Turbo_DIA_1ng_40SPD_whisper100_1CV_auto.csv"))
LITDIA_Turbo_5_auto <- read.csv2(paste0(lit_path, "20220502_LIT_Turbo_DIA_5ng_40SPD_whisper100_1CV_auto.csv"))
LITDIA_Turbo_10_auto <- read.csv2(paste0(lit_path, "20220502_LIT_Turbo_DIA_10ng_40SPD_whisper100_1CV_auto.csv"))
LITDIA_Turbo_100_auto <- read.csv2(paste0(lit_path, "20220502_LIT_Turbo_DIA_100ng_40SPD_whisper100_1CV_auto.csv"))

LITDIA_Turbo_1_auto$EG.IsImputed %>% table()
```
...
LITDIA_Turbo_1_auto <- filter_pep(LITDIA_Turbo_1_auto)
LITDIA_Turbo_1_auto_filter <- LITDIA_Turbo_1_auto[LITDIA_Turbo_1_auto$filtered == FALSE,]
...
LITDIA_Turbo_5_auto <- filter_pep(LITDIA_Turbo_5_auto)
LITDIA_Turbo_5_auto_filter <- LITDIA_Turbo_5_auto[LITDIA_Turbo_5_auto$filtered == FALSE,]
...
LITDIA_Turbo_10_auto <- filter_pep(LITDIA_Turbo_10_auto)
LITDIA_Turbo_10_auto_filter <- LITDIA_Turbo_10_auto[LITDIA_Turbo_10_auto$filtered == FALSE,]
...
LITDIA_Turbo_100_auto <- filter_pep(LITDIA_Turbo_100_auto)
LITDIA_Turbo_100_auto_filter <- LITDIA_Turbo_100_auto[LITDIA_Turbo_100_auto$filtered == FALSE,]
...
Turbo_vs_7k_1_facet <- 
  inner_join(OTDIA_7k_1_filter[,c(1,6)],
             LITDIA_Turbo_1_auto_filter[,c(1,6)],
...
Turbo_vs_7k_5_facet <- 
  inner_join(OTDIA_7k_5_filter[,c(1,6)],
             LITDIA_Turbo_5_auto_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
...
Turbo_vs_7k_10_facet <- 
  inner_join(OTDIA_7k_10_filter[,c(1,6)],
             LITDIA_Turbo_10_auto_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
...
Turbo_vs_7k_100_facet <-  
  inner_join(OTDIA_7k_100_filter[,c(1,6)],
             LITDIA_Turbo_100_auto_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
...
```{r}
#Turbo
LITDIA_Turbo_1_auto_filter$in_OT <- 
  LITDIA_Turbo_1_auto_filter$PEP.StrippedSequence %in%
  OTDIA_7k_1_filter$PEP.StrippedSequence
LITDIA_Turbo_1_auto_filter$method <- "Turbo"
...
#Input
LITDIA_Turbo_1_auto_filter$input <-
...
```{r}
#Turbo
LITDIA_Turbo_5_auto_filter$in_OT <- 
  LITDIA_Turbo_5_auto_filter$PEP.StrippedSequence %in%
  OTDIA_7k_5_filter$PEP.StrippedSequence
LITDIA_Turbo_5_auto_filter$method <- "Turbo"
...
#Input
LITDIA_Turbo_5_auto_filter$input <-
...
```{r}
#Turbo
LITDIA_Turbo_10_auto_filter$in_OT <- 
  LITDIA_Turbo_10_auto_filter$PEP.StrippedSequence %in%
  OTDIA_7k_10_filter$PEP.StrippedSequence
LITDIA_Turbo_10_auto_filter$method <- "Turbo"
...
#Input
LITDIA_Turbo_10_auto_filter$input <-
...
```{r}
#Turbo
LITDIA_Turbo_100_auto_filter$in_OT <- 
  LITDIA_Turbo_100_auto_filter$PEP.StrippedSequence %in%
  OTDIA_7k_100_filter$PEP.StrippedSequence
LITDIA_Turbo_100_auto_filter$method <- "Turbo"
...
#Input
LITDIA_Turbo_100_auto_filter$input <-
...
```{r}
OT_in_LIT <- 
  rbind(LITDIA_Turbo_1_auto_filter[,c(1,6:10)], LITDIA_Turbo_5_auto_filter[,c(1,6:10)],
        LITDIA_Turbo_10_auto_filter[,c(1,6:10)], LITDIA_Turbo_100_auto_filter[,c(1,6:10)],
...
OTDIA_7k_1_filter$in_LIT <- 
  ...
  LITDIA_Turbo_1_auto_filter$PEP.StrippedSequence
...
OTDIA_7k_100_filter$in_LIT <- 
  ...
  LITDIA_Turbo_100_auto_filter$PEP.StrippedSequence
...
```{r}
Turbo_pep_list <- 
  list('Turbo 1 ng' = LITDIA_Turbo_1_auto_filter$PEP.StrippedSequence,
       'Turbo 5 ng' = LITDIA_Turbo_5_auto_filter$PEP.StrippedSequence,
       'Turbo 10 ng' = LITDIA_Turbo_10_auto_filter$PEP.StrippedSequence,
       'Turbo 100 ng' = LITDIA_Turbo_100_auto_filter$PEP.StrippedSequence)
...
LITDIA_Turbo auto
```{r}
LITDIA_Turbo_1_auto_CV <- LITDIA_Turbo_1_auto[,1:5] %>% 
...
LITDIA_Turbo auto
```{r}
LITDIA_Turbo_5_auto_CV <- LITDIA_Turbo_5_auto[,1:5] %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
LITDIA_Turbo auto
```{r}
LITDIA_Turbo_10_auto_CV <- LITDIA_Turbo_10_auto[,1:5] %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
LITDIA_Turbo
```{r}
LITDIA_Turbo_100_auto_CV <- LITDIA_Turbo_100_auto[,1:5] %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
```{r}
CV_joined <- 
  rbind(LITDIA_Turbo_1_auto_CV, LITDIA_Rapid_1_CV, LITDIA_Normal_1_CV,
      OTDIA_7k_1_CV, OTDIA_15k_1_CV, OTDIA_30k_1_CV,
      LITDIA_Turbo_5_auto_CV, LITDIA_Rapid_5_CV, LITDIA_Normal_5_CV,
      OTDIA_7k_5_CV, OTDIA_15k_5_CV, OTDIA_30k_5_CV,
      LITDIA_Turbo_10_auto_CV, LITDIA_Rapid_10_CV, LITDIA_Normal_10_CV,
      OTDIA_7k_10_CV, OTDIA_15k_10_CV, OTDIA_30k_10_CV,
      LITDIA_Turbo_100_auto_CV, LITDIA_Rapid_100_CV, LITDIA_Normal_100_CV,
...
lim <- 
  c(boxplot.stats(log10(CV_joined[CV_joined$method ==
                                    "LITDIA_Turbo",]$CV*100))$stats[c(1,5)],
    boxplot.stats(log10(CV_joined[CV_joined$method ==
                                    "LITDIA_Rapid",]$CV*100))$stats[c(1,5)],
    boxplot.stats(log10(CV_joined[CV_joined$method ==
                                    "LITDIA_Normal",]$CV*100))$stats[c(1,5)],
    boxplot.stats(log10(CV_joined[CV_joined$method ==
                                    "OTDIA_7k",]$CV*100))$stats[c(1,5)],
    boxplot.stats(log10(CV_joined[CV_joined$method ==
                                    "OTDIA_15k",]$CV*100))$stats[c(1,5)],
    boxplot.stats(log10(CV_joined[CV_joined$method ==
                                    "OTDIA_30k",]$CV*100))$stats[c(1,5)])
...
```{r}
inner_join(LITDIA_Turbo_1_auto_CV[, c(1, 4)],
           OTDIA_7k_1_CV[, c(1, 4)],
           by = "PEP.StrippedSequence") %>% 
...
id_LITDIA_Turbo_1_auto <- id_LITDIA_Turbo_5_auto <- id_LITDIA_Turbo_10_auto <- id_LITDIA_Turbo_100_auto <- 
...
```{r}
for(i in 2:5){
id_LITDIA_Turbo_1_auto[i-1] <- sum(!is.na(LITDIA_Turbo_1_auto[, i]))}
```
...
```{r}
for(i in 2:5){
id_LITDIA_Turbo_5_auto[i-1] <- sum(!is.na(LITDIA_Turbo_5_auto[, i]))}
```
...
```{r}
for(i in 2:5){
id_LITDIA_Turbo_10_auto[i-1] <- sum(!is.na(LITDIA_Turbo_10_auto[, i]))}
```
...
```{r}
for(i in 2:5){
id_LITDIA_Turbo_100_auto[i-1] <- sum(!is.na(LITDIA_Turbo_100_auto[, i]))}
```
...
id_pep <- data.frame(method = rep(c(rep("OT 7.5k", 4), rep("OT 15k", 4), rep("OT 30k", 4),
           ...
           id = c(id_OTDIA_7k_1, id_OTDIA_15k_1, id_OTDIA_30k_1, 
                  id_LITDIA_Turbo_1_auto, id_LITDIA_Rapid_1, id_LITDIA_Normal_1,
                  id_OTDIA_7k_5, id_OTDIA_15k_5, id_OTDIA_30k_5, 
                  id_LITDIA_Turbo_5_auto, id_LITDIA_Rapid_5, id_LITDIA_Normal_5,
                  id_OTDIA_7k_10, id_OTDIA_15k_10, id_OTDIA_30k_10, 
                  id_LITDIA_Turbo_10_auto, id_LITDIA_Rapid_10, id_LITDIA_Normal_10,
                  id_OTDIA_7k_100, id_OTDIA_15k_100, id_OTDIA_30k_100, 
                  id_LITDIA_Turbo_100_auto, id_LITDIA_Rapid_100, id_LITDIA_Normal_100),
...
```{r}
temp <- id_plot +  CV_plot + plot_layout(widths = c(1, 2))
...
pp_plot <- (plot_40SPD + 
  ...
  (plot_20SPD + 
     scale_y_log10(limits = limit,
                   breaks = c(3, 6, 10, 30))+
     theme(axis.title.y = element_text(hjust = -2.5, vjust = 1)))
pp_plot
```
...
id_acc_40SPD <- pp %>% 
  ...
  filter(IT == "40 SPD" &
           input != "100 ng") %>% 
  ggplot(aes(x = input, y = n_acc/3, group = method, color = method)) +
  geom_line(size = 2.5) +
  geom_point(size = 4) +
  theme_classic2() +
...
id_acc_20SPD <- pp %>% 
  ...
  labs(color = "Scanning method",
       x = "Input",
       y = "Peptides with number of points across a peak >= 6")+
...
#30ms 30w
LITDIA_Rapid_40SPD_30ms_3Ow_1 <- read.csv2(paste0(lit_path, "20220509_LIT_Rapid_DIA_1ng_40SPD_whisper100_1CV_30ms_30w.csv"))
```
...
LITDIA_Rapid_40SPD_30ms_3Ow_1 <- filter_pep(LITDIA_Rapid_40SPD_30ms_3Ow_1)
```
...
id_LITDIA_Rapid_40SPD_23ms_40w_1 <- id_LITDIA_Rapid_40SPD_31ms_34w_1 <- 
  id_LITDIA_Rapid_40SPD_31ms_25w_1 <- id_LITDIA_Rapid_40SPD_30ms_3Ow_1 <-
...
30ms 30w
```{r}
for(i in 2:(ncol(LITDIA_Rapid_40SPD_30ms_3Ow_1)-2)){
  id_LITDIA_Rapid_40SPD_30ms_3Ow_1[i-1] <- sum(!is.na(LITDIA_Rapid_40SPD_30ms_3Ow_1[, i]))}
```
...
LITDIA_Rapid_40SPD_30ms_3Ow_1
```{r}
LITDIA_Rapid_40SPD_30ms_3Ow_1_CV <- LITDIA_Rapid_40SPD_30ms_3Ow_1[,1:4] %>% 
  pivot_longer(names_to = "Sample", 
               values_to = "Quantity", 
               -PEP.StrippedSequence) %>% 
  group_by(PEP.StrippedSequence) %>% 
...
```{r}
CV_it_joined <- 
  rbind(LITDIA_Rapid_40SPD_23ms_40w_1_CV, LITDIA_Rapid_40SPD_30ms_3Ow_1_CV, 
...
```{r}
method_details <- 
  read.csv("C:/Users/samgr/OneDrive - UCL/Documents/Internship/Data/LITDIA/method_table.csv")
...
welcome_to_dk <- 
  Reduce(function(...) merge(..., all = TRUE, by = "PEP.StrippedSequence"),
       list(LITDIA_Turbo_1_auto_filter[,c(1,6)], LITDIA_Turbo_5_auto_filter[,c(1,6)],
            LITDIA_Turbo_10_auto_filter[,c(1,6)], LITDIA_Turbo_100_auto_filter[,c(1,6)],
...
create x_clean for pivoted data to have
- x as spectronaut output
- x_clean with pivoted data and filter highlight
- x_filter for filtered data

create a function compute CV

heatmap for coefficients of correlation
