...
1 ng
```{r}
Turbo_vs_7k_1_figure1c_join <- 
  inner_join(OTDIA_7k_1_filter[,c(1,6)],
             LITDIA_Turbo_1_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Turbo_vs_7k_1_figure1c_join$method <- "LIT Turbo vs OT 7.5k"
Turbo_vs_7k_1_figure1c_join$input <- "1 ng"

Rapid_vs_15k_1_figure1c_join <-  
  inner_join(OTDIA_15k_1_filter[,c(1,6)],
             LITDIA_Rapid_1_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Rapid_vs_15k_1_figure1c_join$method <- "LIT Rapid vs OT 15k"
Rapid_vs_15k_1_figure1c_join$input <- "1 ng"

Normal_vs_30k_1_figure1c_join <-  
  inner_join(OTDIA_30k_1_filter[,c(1,6)],
             LITDIA_Normal_1_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Normal_vs_30k_1_figure1c_join$method <- "LIT Normal vs OT 30k"
Normal_vs_30k_1_figure1c_join$input <- "1 ng"
```

5 ng
```{r}
Turbo_vs_7k_5_figure1c_join <- 
  inner_join(OTDIA_7k_5_filter[,c(1,6)],
             LITDIA_Turbo_5_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Turbo_vs_7k_5_figure1c_join$method <- "LIT Turbo vs OT 7.5k"
Turbo_vs_7k_5_figure1c_join$input <- "5 ng"

Rapid_vs_15k_5_figure1c_join <-  
  inner_join(OTDIA_15k_5_filter[,c(1,6)],
             LITDIA_Rapid_5_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Rapid_vs_15k_5_figure1c_join$method <- "LIT Rapid vs OT 15k"
Rapid_vs_15k_5_figure1c_join$input <- "5 ng"

Normal_vs_30k_5_figure1c_join <-  
  inner_join(OTDIA_30k_5_filter[,c(1,6)],
             LITDIA_Normal_5_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Normal_vs_30k_5_figure1c_join$method <- "LIT Normal vs OT 30k"
Normal_vs_30k_5_figure1c_join$input <- "5 ng"
```

10 ng
```{r}
Turbo_vs_7k_10_figure1c_join <- 
  inner_join(OTDIA_7k_10_filter[,c(1,6)],
             LITDIA_Turbo_10_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Turbo_vs_7k_10_figure1c_join$method <- "LIT Turbo vs OT 7.5k"
Turbo_vs_7k_10_figure1c_join$input <- "10 ng"

Rapid_vs_15k_10_figure1c_join <-  
  inner_join(OTDIA_15k_10_filter[,c(1,6)],
             LITDIA_Rapid_10_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Rapid_vs_15k_10_figure1c_join$method <- "LIT Rapid vs OT 15k"
Rapid_vs_15k_10_figure1c_join$input <- "10 ng"

Normal_vs_30k_10_figure1c_join <-  
  inner_join(OTDIA_30k_10_filter[,c(1,6)],
             LITDIA_Normal_10_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Normal_vs_30k_10_figure1c_join$method <- "LIT Normal vs OT 30k"
Normal_vs_30k_10_figure1c_join$input <- "10 ng"
```

100 ng  
```{r}
Turbo_vs_7k_100_figure1c_join <-  
  inner_join(OTDIA_7k_100_filter[,c(1,6)],
             LITDIA_Turbo_100_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Turbo_vs_7k_100_figure1c_join$method <- "LIT Turbo vs OT 7.5k"
Turbo_vs_7k_100_figure1c_join$input <- "100 ng"

Rapid_vs_15k_100_figure1c_join <- 
  inner_join(OTDIA_15k_100_filter[,c(1,6)],
             LITDIA_Rapid_100_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Rapid_vs_15k_100_figure1c_join$method <- "LIT Rapid vs OT 15k"
Rapid_vs_15k_100_figure1c_join$input <- "100 ng"

Normal_vs_30k_100_figure1c_join <- 
  inner_join(OTDIA_30k_100_filter[,c(1,6)],
             LITDIA_Normal_100_filter[,c(1,6)],
             by = "PEP.StrippedSequence",
             suffix = c("_OT", "_LIT"))
Normal_vs_30k_100_figure1c_join$method <- "LIT Normal vs OT 30k"
Normal_vs_30k_100_figure1c_join$input <- "100 ng"
```

## Join C

```{r}
figure1c_join <- rbind(Turbo_vs_7k_1_figure1c_join, Rapid_vs_15k_1_figure1c_join, Normal_vs_30k_1_figure1c_join,
               Turbo_vs_7k_5_figure1c_join, Rapid_vs_15k_5_figure1c_join, Normal_vs_30k_5_figure1c_join,
               Turbo_vs_7k_10_figure1c_join, Rapid_vs_15k_10_figure1c_join, Normal_vs_30k_10_figure1c_join,
               Turbo_vs_7k_100_figure1c_join, Rapid_vs_15k_100_figure1c_join, Normal_vs_30k_100_figure1c_join)

figure1c_join$method <- factor(figure1c_join$method,
                       levels = c("LIT Turbo vs OT 7.5k",
                                  "LIT Rapid vs OT 15k",
                                  "LIT Normal vs OT 30k"))
figure1c_join$input = factor(figure1c_join$input, levels = unique(figure1c_join$input))
```
