...
# Fig. 10 Dynamic range of quantified peptides from LCM tonsil tissue with a 52500 µm2 surface area. 
...
temp <- a %>%
  ...
  mutate(rank = as.numeric(as.factor(dplyr::desc(prot_quantity))),
...
#cairo_pdf(filename = "fig10.pdf", width = 12.5, height = 6.77)
#rank_plot
#dev.off()
```